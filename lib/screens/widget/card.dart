          ...
          children: [
            Row(// for image and protion of right side of images
              ...
              Container(
                height: 100.0,
                width: 100.0,
                child: Image.network(widget.pathOfimg),
              ), //Image show
              SizedBox(width: 8.0),
              SizedBox(
...
Widget datetimeRow(
    int type, String date, String time, List<String> projectDetail, int workingPhase) {
  return type == 4
      ? SizedBox(
          ...
          child: Row(
            ...
            children: [
              SafeArea(child: circulerProjectDetails(projectDetail[1], 1, workingPhase)),
