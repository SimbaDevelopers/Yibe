      ...
      body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.data == null || snapshot.data.documents.length == 0) {
              return Center(
                  child: Container(child: Text('No connections yet')));
            }
                    ...
                    GestureDetector(
                      onTap: () {
                        DatabaseService.instance
                            .getAnyPvtUserInfo(users[i].data()['uid'])
                            .then((value) => {
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          backgroundImage: NetworkImage(users[i].data()[
                              'profileUrl']), //TODO: Change with updated profile pic
                        ),
