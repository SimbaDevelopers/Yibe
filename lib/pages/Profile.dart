...
class _ProfileState extends State<Profile> {
  ...
  void initState() {
    ...
    DatabaseService.instance
        .getPvtCurrentUserInfo(UniversalVariables.myPvtUid)
        .then((value) => {
              value['privateUrl'] != null && value['pvtBio'] != null
                  ? setState(() {
  ...
  void CountofProfFollowersAndFollowing() {
    DatabaseService.instance
        .getProfFollowersCountOfAUser(
            UniversalVariables.myPvtUid, UniversalVariables.myProfUid)
        .then((value) => setState(() {
    ...
    DatabaseService.instance
        ...
        .then((value) => setState(() {
              ...
              print(proffollowingsCount.toString() +
                  ' following in view my prof');
            }));
  }
  ...
  void CountofConnectionsandFollowings() {
    ...
    DatabaseService.instance
        ...
        .then((value) => setState(() {
              ...
              print(
                  pvtfollowingsCount.toString() + ' followings in my profile');
            }));
  }
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: model.isPrivate
                                        ? NetworkImage(privateUrl)
                                        : NetworkImage(profUserMap['profUrl']),
                                    fit: BoxFit.cover),
                              ),
                            ),
                            SizedBox(
                              ...
                              onTap: () {
                                model.isPrivate
                                    ? NavigationService.instance
                                        .pushNamedTo('editPrivate')
                                    : NavigationService.instance
                                        .pushNamedTo('editProfessional');
                              },
                              child: Container(
                                width: 300,
                                height: 30.0,
                                      ...
                                      SizedBox(
                                        ...
                                        child: ownPhoto
                                            ? Container(
                                                ...
                                                child: StreamBuilder<
                                                        QuerySnapshot>(
                                                    stream: model.isPrivate
                                                        ? DatabaseService
                                                            .instance
                                                            .getAllMyPvtPostImage()
                                                        : DatabaseService
                                                            .instance
                                                            .getAllMyProfPostImage(),
                                                    builder:
                                                        (context, snapshot) {
                                                      if (snapshot
                                                              .connectionState ==
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ListTile(
                                                                            ...
                                                                            subtitle:
                                                                                Text(
                                                                              timeago.format(DateTime.tryParse(museSnippet[i].data()['timestamp'].toDate().toString())).toString(),
                                                                              style: TextStyle(
                                                                                fontFamily: 'Poppins',
                                                                                fontSize: 14.0,
