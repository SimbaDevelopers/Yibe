...
class DatabaseService {
  ...
  Future<void> createPvtUserInAllUserCollection(
      Map UserMap, String userId) async {
    try {
      await _db
          .collection(_allUserCollection)
          .doc('PVT - ' + userId)
          .set(UserMap);
    } catch (e) {
      print(e);
  ...
  Future<void> createProfUserInDB(Map prfUserMap) async {
    try {
      await _db
          ...
          .doc(UniversalVariables.myPvtUid)
          .collection(_profAccount)
          .doc(prfUserMap['profId'])
          .set(prfUserMap);
    } catch (e) {
      print(e);
    }
  ...
  Future<Map> getAnyPvtUserInfo(String pvtId) async {
    DocumentSnapshot doc =
        await _db.collection(_userCollection).doc(pvtId).get();
    return doc.data();
  }
  ...
  Future<String> getPvtProfileUrlofAUser(String chattingWithId) async {
    try {
      DocumentSnapshot doc =
          await _db.collection(_userCollection).doc(chattingWithId).get();
  ...
  Future<void> updatePrivateUserInfo(String bio, String imageUrl) async {
    ...
    try {
      _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .update({'pvtBio': bio, 'privateUrl': imageUrl});
      _db
          .collection(_allUserCollection)
          .doc('PVT - ' + UniversalVariables.myPvtUid)
          .update({'pvtBio': bio, 'privateUrl': imageUrl});
    } catch (e) {
      print(e);
    }
  ...
  Future<void> updateHaveAProfAc(String profId) async {
    ...
    try {
      _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .update({'haveProfAc': true, 'profId': profId});
      _db
          .collection(_allUserCollection)
          .doc('PVT - ' + UniversalVariables.myPvtUid)
          .update({'haveProfAc': true, 'profId': profId});
  ...
  Future<Map> getProfCurrentUserInfo() async {
    try {
      ...
      DocumentSnapshot doc = await _db
          ...
          .doc(UniversalVariables.myPvtUid)
          .collection(_profAccount)
          .doc(UniversalVariables.myProfUid)
          .get();
      return doc.data();
    } catch (e) {
      print(e);
  ...
  Future<void> updateProfUserInfo(String bio, String imageUrl) async {
    try {
      await _db
          ...
          .collection(_profAccount)
          .doc(UniversalVariables.myProfUid)
          .update({'BusinessBio': bio, 'profUrl': imageUrl});
      await _db
          .collection(_allUserCollection)
          .doc('PRF - ' + UniversalVariables.myProfUid)
          .update({'BusinessBio': bio, 'profUrl': imageUrl});
    } catch (e) {
      print(e);
    }
  ...
  Future<void> sendMyConnectionRequest(Map myConnectionMap) async {
    try {
      await _db
          .collection(_userCollection)
          .doc(myConnectionMap['To'])
          .collection(_privateNotifications)
          .doc(myConnectionMap['From'])
          .set(myConnectionMap);
    } catch (e) {
      print(e);
    }
  ...
  Future<void> acceptConnectionRequest(String otherUserUid,
      Map senderConnectionMap, Map receiverConnectionMap) async {
    try {
      await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
      ...
      await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .collection(_privateConnections)
          .doc(otherUserUid)
          .set(receiverConnectionMap);
      await _db
          .collection(_userCollection)
          .doc(otherUserUid)
          .collection(_privateConnections)
          .doc(UniversalVariables.myPvtUid)
          .set(senderConnectionMap);
    } catch (e) {
      print(e);
    }
  }
  ...
  Future<void> incrementMyPvtFollowing(String otherUserUid) async {
    try {
      DocumentSnapshot doc = await _db
          .collection(_allUserCollection)
          .doc('PRF - ' + otherUserUid)
          .get();
      await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .collection(_privateFollowings)
          .doc(otherUserUid)
          .set({
        'uid': otherUserUid,
        'name': doc.data()['BusinessName'],
        'url': doc.data()['profUrl'],
  ...
  Future<void> sendFollowingConfirmation(
      Map myFollowingMap, String otherUserPvtId) async {
    try {
      ...
      await _db
          ...
          .doc(otherUserPvtId)
          .collection(_profAccount)
          .doc(myFollowingMap['To'])
          .collection(_profNotifications)
          .doc(myFollowingMap['From'])
          .set(myFollowingMap);
    } catch (e) {
      print(e);
    }
  ...
  Future<void> removeFollowerNotification(
      String otherUserPvtId, String otherUserProfId, String myUid) async {
    try {
      await _db
          .collection(_userCollection)
          .doc(otherUserPvtId)
  ...
  Future<void> addMeAsAFollower(String otherUserPvtUid, String otherUserProfUid,
      bool navigatedFromPrivateAc, String myUid) async {
    //myUid can be my pvtUid or profUid depending from which accountType I'll want to become a follower
    try {
      if (navigatedFromPrivateAc) {
        ...
        DocumentSnapshot doc = await _db
            ...
            .doc('PVT - ' + myUid)
            .get();
        doc.data()['privateUrl'] != null
            ? url = doc.data()['privateUrl']
            : url = UniversalVariables.defaultImageUrl;
        await _db
            .collection(_userCollection)
            .doc(otherUserPvtUid)
            .collection(_profAccount)
            .doc(otherUserProfUid)
            .collection(_profFollowers)
            .doc(myUid)
            .set({
          'uid': myUid,
  ...
  Future<void> removeMeAsAFollower(
      String otherUserPvtUid, String otherUserProfUid, String myUid) async {
    //myUid can be my pvtUid or profUid depending from which accountType I'll unfollow
    try {
      await _db
          .collection(_userCollection)
          .doc(otherUserPvtUid)
  ...
  Future<int> getConnectionCountOfAUser(String uid) async {
    try {
      QuerySnapshot connections = await _db
          .collection(_userCollection)
          .doc(uid)
          .collection(_privateConnections)
          .get();
  ...
  Future<int> getProfFollowingCountOfAUser(
      String pvtUid, String profUid) async {
    try {
      QuerySnapshot followings = await _db
          .collection(_userCollection)
          .doc(pvtUid)
          .collection(_profAccount)
          .doc(profUid)
  ...
  Future<int> getProfFollowersCountOfAUser(
      String pvtUid, String profUid) async {
    try {
      QuerySnapshot followers = await _db
          .collection(_userCollection)
          .doc(pvtUid)
          .collection(_profAccount)
          .doc(profUid)
  ...
  void uploadPvtPost(Map newPostMap, String postId) async {
    return await _db
        .collection(_userCollection)
        .doc(UniversalVariables.myPvtUid)
        .collection(_privatePosts)
        .doc(postId)
        .set(newPostMap);
    // await _db.collection('Posts').doc().set(newPostMap);
  }

  void AddImagePostToMyConnectionFeed(
      String name,
      String image,
      String caption,
      String postId,
    ...
    if (relationType == 'CF') {
      //if user selects CF, send post to only CF connection
      print(relationType);
      return await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .collection(_privateConnections)
          .where('myRelation', isEqualTo: relationType)
          .get()
          .then((snapshot) => snapshot.docs.forEach((doc) {
                ...
                _db
                    .collection(_userCollection)
                    .doc(doc.data()['uid'])
                    .collection(_privateFeeds)
                    .doc(postId)
                    .set(newPostMap.toMap(newPostMap));
              }));
    } else if (relationType == 'F') {
      //if user selects F, send post to connections - CF,F
      print(relationType);
      await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .collection(_privateConnections)
          .where('myRelation', isEqualTo: 'CF')
          .get()
          .then((snapshot) {
      ...
      //if user selects All, send post to all connections - CF,F,AQ
      print(relationType);
      return await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
  ...
  void AddMusePostToMyConnectionFeed(String name, String image, String postId,
      String museText, Timestamp timestamp, String relationType) async {
    Post newPostMap = Post();
    final String postFor = 'Incircle';
    if (relationType == 'CF') {
      //if user selects CF, send post to only CF connection
      ...
      return await _db
          ...
          .then((snapshot) => snapshot.docs.forEach((doc) {
                ...
                _db
                    ...
                    .collection(_privateFeeds)
                    .doc(postId)
                    .set(newPostMap.toMapMuse(newPostMap));
              }));
    } else if (relationType == 'F') {
      //if user selects F, send post to connections - CF,F
      print(relationType);
  ...
  void uploadProfPost(Map newPostMap, String postId) async {
    return await _db
        ...
        .collection(_profAccount)
        .doc(UniversalVariables.myProfUid)
        .collection(_profPosts)
        .doc(postId)
        .set(newPostMap);
    //await _db.collection('Posts').doc().set(newPostMap);
  }

  void AddMyProfPostToMyFollowersFeed(
      Map newPostMap, String relationType, String postId) async {
    return await _db
        .collection(_userCollection)
        .doc(UniversalVariables.myPvtUid)
        .collection(_profAccount)
  ...
  Stream<QuerySnapshot> getAllProfPostImageofOtherUser(
      String pvtId, String profId) {
    return _db
        .collection(_userCollection)
        .doc(pvtId)
        .collection(_profAccount)
  ...
  Stream<QuerySnapshot> getAllProfPostMuseofOtherUser(
      String pvtId, String profId) {
    return _db
        .collection(_userCollection)
        .doc(pvtId)
  ...
  Stream<QuerySnapshot> getAllCloseFriendsFeeds() {
    return _db
        ...
        .doc(UniversalVariables.myPvtUid)
        .collection(_privateFeeds)
        .where('myRelation1', isEqualTo: 'CF')
        .orderBy('timestamp', descending: true)
        .snapshots();
  }
  ...
  Stream<QuerySnapshot> getAllAcquaintanceFeeds() {
    return _db
        ...
        .doc(UniversalVariables.myPvtUid)
        .collection(_privateFeeds)
        .where('postFor', isEqualTo: 'Incircle')
        .orderBy('timestamp', descending: true)
        .snapshots();
  }
  ...
  Stream<QuerySnapshot> getAllPvtFollowingsFeeds() {
    return _db
        ...
        .doc(UniversalVariables.myPvtUid)
        .collection(_privateFeeds)
        .where('postFor', isEqualTo: 'Follower')
        .orderBy('timestamp', descending: true)
        .snapshots();
  }
  ...
  Future<void> addLikeToAPostInMyPvtFeed(Map likeMap, String postId,
      String posterId, String postFor, String postUrl) async {
    try {
      await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
      ...
      if (postFor == 'Follower') {
        ...
        await _db
            ...
            .then((value) => _db
                ...
                .collection(_profNotifications)
                .doc(postId)
                .update({'postUrl': postUrl, 'postId': postId}));
      } else {
        print(posterId);
        await _db
            .collection(_userCollection)
  ...
  Future<void> removeLikeFromAPostInMyPvtFeed(
      String postId, String posterId) async {
    try {
      await _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
  ...
  Future<void> addLikeToAPostInMyProfFeed(Map likeMap, String postId,
      String posterId, String postFor, String postUrl) async {
    try {
      await _db
          .collection(_userCollection)
  ...
  Future<void> removeLikeFromAPostInMyProfFeed(
      String postId, String posterId) async {
    try {
      await _db
          .collection(_userCollection)
  ...
  Stream<List<ConversationSnippet>> getFollowingUserConversations() {
    var _ref = _db
        ...
        .collection(_privateChats);
    return _ref
        .where('myRelation', isEqualTo: 'Following')
        .snapshots()
        .map((snapshot) {
      print(snapshot.docs);
      return snapshot.docs.map((doc) {
  ...
  Stream<List<ConversationSnippet>> getProfUserDirectConversations() {
    var _ref = _db
        ...
        .collection(_profAccount)
        .doc(UniversalVariables.myProfUid)
        .collection(_profChats);
    return _ref
        .where('typeOfConversation', isEqualTo: 'Direct')
        .snapshots()
        .map((_snapshot) {
      // _snapshot is an instance of query snapshot
      return _snapshot.docs.map((_doc) {
        //_doc is an instance of query doc snapshot
  ...
  Stream<List<ConversationSnippet>> getProfUserRequestConversations() {
    var _ref = _db
        ...
        .collection(_profChats);
    return _ref
        .where('typeOfConversation', isEqualTo: 'Request')
        .snapshots()
        .map((_snapshot) {
      // _snapshot is an instance of query snapshot
      return _snapshot.docs.map((_doc) {
  ...
  Future<void> moveProfRMToDM(String chattingWithId) async {
    ...
    return _db
        ...
        .collection(_profChats)
        .doc(chattingWithId)
        .update({'typeOfConversation': 'Direct'});
  }
  ...
  Stream<ConversationEssentials> getConversation(String chatRoomId) {
    ...
    return _ref.snapshots().map(
      (_doc) {
        return ConversationEssentials.fromFirestore(_doc);
      },
    );
  }
  ...
  Future<void> createOrGetConversation(
      ...
      Future<void> Function(String chatRoomId) _onSuccess) async {
    var ref = _db.collection(_allChats);
    var userConversationRef;
    if (ownerAcType == 'Private') {
      userConversationRef = _db
          .collection(_userCollection)
          .doc(UniversalVariables.myPvtUid)
          .collection(_privateChats);
  ...
  Stream<List<ConversationSnippet>> getPvtSelectiveConversations() {
    var _ref = _db
        ...
        .collection(_privateChats);
    return _ref
        .where('InSelective', isEqualTo: true)
        .snapshots()
        .map((_snapshot) {
      // _snapshot is an instance of query snapshot
      return _snapshot.docs.map((_doc) {
